...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Posts /</span><span> Show Posts</span>
        </h4>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div
                    ...
                    <div class="d-flex flex-column justify-content-center">
                        <h4 class="mb-1 mt-3">Show Posts</h4>
                    </div>
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h5 class="card-tile mb-0">Thông tin Posts</h5>
                            </div>
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="Tên người dùng" value="{{ $post['p_id'] }}" name="name"
                                        aria-label="Tên người dùng" required disabled>
                                    <label for="ecommerce-product-name">ID</label>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="title" value="{{ $post['p_title'] }}" name="name"
                                        aria-label="Tên người dùng" required disabled>
                                    <label for="ecommerce-product-name">title</label>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="excerpt" value="{{ $post['p_excerpt'] }}" name="name"
                                        aria-label="Tên người dùng" required disabled>
                                    <label for="ecommerce-product-name">excerpt</label>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="content" value="{{ $post['p_content'] }}" name="name"
                                        aria-label="Tên người dùng" required disabled>
                            ...
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="image" name="name" aria-label="Tên người dùng" required>
                            ...
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="category_id " value="{{ $post['c_name'] }}" name="name"
                                        aria-label="Tên người dùng" required disabled>
                                    <label for="ecommerce-product-name">category_id </label>
                                </div>
                            </div>
                        </div>
                        <!-- /Product Information -->
