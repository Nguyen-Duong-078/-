...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Posts /</span><span> Add Posts</span>
        </h4>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div
                    ...
                    <div class="d-flex flex-column justify-content-center">
                        <h4 class="mb-1 mt-3">Add a new Posts</h4>
                    </div>
                    <div class="d-flex align-content-center flex-wrap gap-3">
                        <button type="reset" class="btn btn-outline-secondary">Loại Bỏ</button>
                        <button type="submit" class="btn btn-primary">Thêm posts</button>
                    </div>
                </div>
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="Title" name="title" aria-label="Title" required autofocus>
                            ...
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="Excerpt" name="excerpt" aria-label="excerpt" required>
                            ...
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="Content" name="content" aria-label="content" required>
