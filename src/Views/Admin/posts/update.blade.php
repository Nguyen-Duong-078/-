...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <h4 class="py-3 mb-4">
            <span class="text-muted fw-light">Posts /</span><span> Update Posts</span>
        </h4>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div
                    ...
                    <div class="d-flex flex-column justify-content-center">
                        <h4 class="mb-1 mt-3">Update Posts</h4>
                    </div>
                    ...
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="card mb-4">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control" id="category_id" required name="category_id">
                                        @foreach ($categories as $category)
                                            <option @if ($category['id'] == $post['p_category_id']) selected @endif
                                                value="{{ $category['id'] }}">
                            ...
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="Title" value="{{ $post['p_title'] }}" name="title" aria-label="Title"
                                        required>
                            ...
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="Excerpt" value="{{ $post['p_excerpt'] }}" name="excerpt"
                                        aria-label="excerpt" required>
                            ...
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    <input type="text" class="form-control" id="ecommerce-product-name"
                                        placeholder="Content" value="{{ $post['p_content'] }}" name="content"
                            ...
                            <div class="card-body">
                                <div class="form-floating form-floating-outline mb-4">
                                    ...
                                    <img src="{{ $post['p_image'] }}" alt="" width="70px" height="50px">
